            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-sm" style="text-align: right;margin-right: 5%;">
                  <a class="col-sm" href="http://localhost/smkn_1_pasaman/absensi/operator/rombel/tambah_mapel" style=""><h1 id="xs" ><i class="icon-plus-sign" style="color:mediumseagreen;"></i> </h1></a>
                </div>
              </div>
            </div>
                        ...
                        while($dataMapel = mysqli_fetch_array($queryDataMapel)){?>
                          ...
                          if ($dataMapel['kosentrasi']!=0) {
                            ...
                            while ($dataKosentrasi=mysqli_fetch_array($queryKosentrasi)) {
                              ...
                              # code...
                              echo $dataKosentrasi['nama_jurusan']."-".$dataKosentrasi['kosentrasi_jurusan']; 
                              }else{
                                echo $dataKosentrasi['nama_jurusan']; 
                              }
                            }
                          }
                          ?></td>
