            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-sm" style="text-align: right;margin-right: 5%;">
                  <a class="col-sm" href="http://localhost/smkn_1_pasaman/absensi/operator/rombel/tambah_jurusan" style=""><h1 id="xs" ><i class="icon-plus-sign" style="color:mediumseagreen;"></i> </h1></a>
                </div>
              </div>
            </div>
                      ...
                      <!-- <div class="widget-content nopadding"> -->
                       <table class="table table-bordered">
                        ...
                        if(empty($halaman)){
                          ...
                          $queryDataJurusan = mysqli_query($konek,"SELECT * FROM jurusan limit $posisi,$batas");
                          if ($posisi !=0) {
                          // code...
