        ...
        <div class="col-12">
          <div class="details-content">
            <div class="container">
              <div class="row">
                <div class="col-sm">
                  <h2 id="xs" ><i class="icon-calendar"></i> TAHUN AJARAN </h2>
                </div>
                <div class="col-sm" style="text-align: right;margin-right: 5%;">
                  <a class="col-sm" href="http://localhost/smkn_1_pasaman/absensi/operator/rombel/tambah_ta" style=""><h1 id="xs" ><i class="icon-plus-sign" style="color:mediumseagreen;"></i> </h1></a>
                </div>
              </div>
            </div>
                     ...
                     <table class="table table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center" style="background-color: #404040; color:white;">SEMESTER</th>
                          <th class="text-center" style="background-color: #404040; color:white;">TAHUN PELAJARAN</th>
                      ...
                      <tbody>
                        ...
                        $queryDataTa = mysqli_query($konek,"SELECT * FROM ta limit $posisi,$batas");
                        if ($posisi !=0) {
                        $no = $posisi;
                        }else{
                          $no=1;
                        ...
                        while($dataTa = mysqli_fetch_array($queryDataTa)){?>
                          ...
                          <td ><?php echo $dataTa['semester']; ?></td>
                          
                          <td class="text-center"><?php echo $dataTa['tahun_ajaran']; ?></td>
                        ...
                        <nav>
                          <ul class="pagination justify-content-center">
                            ...
                            for($i=1;$i<=$jumlahhalaman;$i++) {
                              if ($i != $halaman) {
                                echo "<li class='page-item'><a class='page-link' href='ta.php?halaman=$i'>$i</a></li>";
                              } 
                              else {
