          ...
          <div class="details-content">
            ...
            <div>
              <div id="myDiv" class="container-fluid">
                <form action="../prosses.php?tipe=ruangan" method="post" class="form-container" style="margin:10px" autocomplete="false">
                <div style="width: 100%; text-align: center;">
                  <h1>Tambahkan RUANGAN</h1></div>
                  ...
                  <div class="row mb-3">
                    ...
                    :
                    <div class="col-sm-8">
                      <input type="text" class="form-control"  placeholder="Nama Lokal" name="ruangan">
                    </div>
                  </div>
