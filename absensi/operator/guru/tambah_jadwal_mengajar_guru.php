        ...
        <div class="col-12">
          <div class="details-content">
            <div class="container">
              <div class="row">
                ...
                <div class="col-sm" style="text-align: right;margin-right: 5%;">
                  <a class="col-sm" href="http://localhost/smkn_1_pasaman/absensi/operator/guru/tambah_guru" style=""><h1 id="xs" ><i class="icon-plus-sign" style="color:mediumseagreen;"></i> </h1></a>
                </div>
              </div>
            </div>
            <div id="myDiv" class="container-fluid">
              <hr>
              <div class="m-4">
                <form action="../prosses.php?tipe=jadwalMengajar" method="post" class="form-container" style="margin:10px" autocomplete="false">
                <div style="width: 100%; text-align: center;">
                  <h1>Tambahkan Jam Mengajar</h1></div>
                  <br>
                  <div class="row mb-3">
                    <label class="col-sm-2 col-form-label">Ruangan</label>
                    :
                    <div class="col-sm-8">
                      <select name="ruangan" class="form-control" id="kelas">
                        <option value="">Ruangan</option>
                        <?php 
                        $queryDataRuangan = mysqli_query($konek, "SELECT * FROM ruangan");
                        while($dataRuangan = mysqli_fetch_array($queryDataRuangan)){
                          ?>
                          <option value="<?php echo $dataRuangan['id_ruangan']; ?>"><?php echo $dataRuangan['kelas']; ?> - <?php echo $dataRuangan['nama_ruangan']; ?></option>
                        <?php
                        } ?>
                      </select>
                    </div>
                    ...
                    <div class="col-sm-8">
                      <select name="ta" class="form-control" id="ta">
                       ...
                       while($dataTa = mysqli_fetch_array($queryDataTa)){
                        ?>
                        <option value="<?php echo $dataTa['id_ta']; ?>"><?php echo "Semester ".$dataTa['semester']." Tahun Ajaran ".$dataTa['tahun_ajaran']; ?></option>
                        <?php } ?>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10 offset-sm-2">
                      <input type="batal" value="Kembali" name="batal" onclick="closeForm('jadwal_mengajar_guru')" style="width:25%; background: #ff3333;" />
