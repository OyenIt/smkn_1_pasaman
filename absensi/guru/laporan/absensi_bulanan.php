                              ...
                              foreach($query_tampilSiswa as $items){
                               ...
                               <tr>
                                ...
                                foreach($daterange as $date1){
                                  ...
                                  $queryDataAbsensi = mysqli_query($konek,"SELECT * FROM absensi_siswa  WHERE siswa=".$items['id_siswa']." AND ruangan=".$get_ruangan." AND jurusan=".$get_jurusan." AND jam_absensi=".$i." AND tgl_absensi='".$tglDimulai."' AND ta=".$_GET['ta']);
