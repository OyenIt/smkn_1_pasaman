...
<body>
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark p-md-2"  id="nav">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			...
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link text-white" style="font-weight: 600; font-size: 1.2em;" href="http://localhost/smkn_1_pasaman/absensi/">Home</a>
				</li>
				<li class="nav-item">
				...
				<a class="btn btn-outline-info" style="margin: 5px; color:white; border-color: #0099cc;" href="http://localhost/smkn_1_pasaman/absensi/login" role="button">MASUK</a>
			</ul>
		</div>
	</div>
</nav>
<div class="banner-image w-100 vh-100 d-flex justify-content-center align-items-center">
	<div class="content text-center">
		...
		<a class="btn btn-outline-info active" style="margin: 5px; color:white; border-color: #0099cc; background: #0099cc: ;" href="http://localhost/smkn_1_pasaman/absensi/login" role="button">MASUK</a>
	</div>
</div>
<br>
<section id="services">
...
<script src="http://localhost/smkn_1_pasaman/absensi/assets/js/custom/custom.js"></script> 
</body>
</html>